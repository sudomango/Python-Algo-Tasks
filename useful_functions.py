...
# Функция num_to_array раскладывает целое неотрицательное число в массив (список), состоящий из его цифр.
...
# Функция array_to_num, обратная предыдущей = собирает целое неотрицательное число из массива (списка) отдельных цифр.
